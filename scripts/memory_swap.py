...
if __name__ == "__main__":
    ...
    args["D"] = 5
    args["k"] = 150
    args["editing_type"] = "swap"
    args["swap_list"] = [[0,], [1,]]
    folder_path = f'exp_results/memory_editing/{args["editing_type"]}' 
    for coupling_type in ["additive", "multiplicative"]:
        ...
        model, opt_state, losses, training_summary = training_loops.non_associative_Hopfield_Kuramoto(args)
