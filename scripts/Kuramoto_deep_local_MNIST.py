...
if __name__ == "__main__":
    ...
    args["model_name"] = "Kuramoto"
    args["dataset_name"] = "MNIST"
    args["D"] = 3
    N_epoch = 15
    args["N_updates"] = 600 * N_epoch
    args["print_every"] = 200
    args["interaction"] = "deep_GELU_local"
    folder_path = f'exp_results/{args["model_name"]}' 
    for N_augment in [0, 100, 200, 300, 400, 500]:
        ...
        for k_ in [150, 250, 350]:
            ...
            model, opt_state, losses, training_summary = training_loops.Kuramoto_small_world(args)
